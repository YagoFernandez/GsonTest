...
public final class FileUtil {
    ...
    public static String readStringWithEncoding(File file, Charset charset) throws IOException {
        return new String(readCharsWithEncoding(file, charset));
    }
	...
	/**
	 * 
	 * Clase que lee el tag <DataFile>
	 * 
	 * @author yago.fernandez
	 * 
	 */
	public static class MyXMLReader extends DefaultHandler {

		StringBuffer dataFile;
		StringBuffer buffer = new StringBuffer();

		/*
		 * Esta funcion es llamada cuando se produce el evento de ver una nueva
		 * etiqueta
		 */
		...
		public void endElement(String uri, String localName, String qName) {
			if ("DataFile".equals(qName)) {
				dataFile = new StringBuffer(buffer);
				System.out.println("DataFile: " + buffer);
			}
		}
